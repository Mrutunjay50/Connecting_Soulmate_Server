...
const { imageMulter, handleMulterError } = require("../multer/multerImg.js");

module.exports = (app) => {
  app.post("/user-data/:userId", imageMulter, handleMulterError, registerUser);
  ...
  app.put("/user-image-upload/:userId", imageMulter, handleMulterError, addImagesInUser);
